...
public class CartServlet extends HttpServlet
{
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
	{
		...
		try
		{
			...
			+"#footer{position:relative;border:1px solid black;width:100%;height:auto;overflow:auto;bottom:0px;background-image: linear-gradient(#ff512f 0%,#dd2476 51%,#ff512f 100%);}"
			...
			+"#proceed{position:absolute;bottom:22px;overflow:hidden;right:0px;width:auto;height:auto;border:0px;font-weight:bold;background-color: #ebf2ff;}"
